...
@VaneModule(name = "enchantments", bstats = 8640, config_version = 1, lang_version = 6, storage_version = 1)
public class Enchantments extends Module<Enchantments> {
    ...
    public Enchantments() {
        ...
        new org.oddlama.vane.enchantments.enchantments.TreeFelling(this);
